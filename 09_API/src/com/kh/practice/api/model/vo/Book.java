...
public class Book {
	...
	public String toString() {
		return "title : " + title + ", author : " + author + ", publisher : " + publisher + ", publishDate " + pd + ", price : " + price;
	}
	
	Date date1 = new Date();
	SimpleDateFormat pd = new SimpleDateFormat("yyyy년 MM월 dd일");
	String formatDate = pd.format(date1);
